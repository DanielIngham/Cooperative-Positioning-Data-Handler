...
do for [i=1:5] {
	...
	set output sprintf(plots_folder . "/Forward-Velocity-Error/Robot-%d-Foward-Velocity-Error.pdf" , i)
	...
	plot data_folder . "/Forward-Velocity-Error-PDF.dat" index (i-1) using 1:3:2 with boxes title "Forward Velocity Error",\
	...
	set output sprintf(plots_folder . "/Angular-Velocity-Error/Robot-%d-Angular-Velocity-Error.pdf" , i)
	...
	# Plot the extracted values alongside the fitted Gaussian
	plot data_folder . "/Angular-Velocity-Error-PDF.dat" index (i-1) using 1:3:2 with boxes title "Angular Velocity Error",\
	gaussian(x) title sprintf("Gaussian: μ = %f, σ = %f", mu, sigma) with lines linewidth 2 linecolor rgb "red",\
	f(x) title sprintf("GNU Gaussian: μ = %f, σ = %f", a, b) with lines linewidth 2 linecolor rgb "blue"
	...
	set output sprintf(plots_folder . "/Range-Error/Robot-%d-Range-Error.pdf" , i)
	...
	# Plot the extracted values alongside the fitted Gaussian
	plot data_folder . "/Range-Error-PDF.dat" index (i-1) using 1:3:2 with boxes title "Range Error",\
	gaussian(x) title sprintf("Gaussian: μ = %f, σ = %f", mu, sigma) with lines linewidth 2 linecolor rgb "red", \
	f(x) title sprintf("GNU Gaussian: μ = %f, σ = %f", a, b) with lines linewidth 2 linecolor rgb "blue"
	...
	set output sprintf(plots_folder . "/Bearing-Error/Robot-%d-Bearing-Error.pdf" , i)
	...
	# Plot the extracted values alongside the fitted Gaussian
	plot data_folder . "/Bearing-Error-PDF.dat" index (i-1) using 1:3:2 with boxes title "Bearing Error",\
	gaussian(x) title sprintf("Gaussian: μ = %f, σ = %f", mu, sigma) with lines linewidth 2 linecolor rgb "red",\
	f(x) title sprintf("GNU Gaussian: μ = %f, σ = %f", a, b) with lines linewidth 2 linecolor rgb "blue"
