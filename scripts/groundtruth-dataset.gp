...
plot \
	"../data/MRCLAM_Dataset1/output/Groundtruth.dat" index 0 using (stringcolumn(5) eq "r" ? $1 : 1/0):(stringcolumn(5) eq "r" ? $2 : 1/0) with points pointsize 1.4 linecolor rgb "red" pointtype 7 title "Raw",\
...
plot \
	"../data/MRCLAM_Dataset1/output/Groundtruth.dat" index 0 using (stringcolumn(5) eq "r" ? $1 : 1/0):(stringcolumn(5) eq "r" ? $3 : 1/0) with points pointsize 1.4 linecolor rgb "red" pointtype 7 title "Raw",\
...
plot \
	"../data/MRCLAM_Dataset1/output/Groundtruth.dat" index 0 using (stringcolumn(5) eq "r" ? $1 : 1/0):(stringcolumn(5) eq "r" ? $4 : 1/0) with points pointsize 1.4 linecolor rgb "red" pointtype 7 title "Raw",\
